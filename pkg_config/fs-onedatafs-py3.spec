...
%{?scl:%scl_package python3-fs-onedatafs}
...
Name: %{?scl_prefix}python3-fs-onedatafs
Version: %{version}
Release: 1%{?dist}
...
Requires: scl-utils
Requires: %scl_require_package %{scl} python3-onedatafs = %{onedatafs_version}
Requires: python-six
...
install -p -D -m 644 %{SOURCE1} $RPM_BUILD_ROOT/opt/onedata/%{scl}/root/usr/lib/python3.6/site-packages/fs/__init__.py

%clean
rm -rf $RPM_BUILD_ROOT

%files -f INSTALLED_FILES
/opt/onedata/%{scl}/root/usr/lib/python3.6/site-packages/fs/__init__.*
%defattr(-,root,root)
