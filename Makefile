...
conda: package/$(PKG_ID).tar.gz
	...
	source /opt/conda/bin/activate base && \
		...
		package/conda
	echo "onedata-devel/fs.onedatafs/$(PKG_VERSION)/download/linux-64/fs.onedatafs-$(PKG_VERSION)-py27_0.tar.bz2" >> conda-pkg-list.txt
	echo "onedata-devel/fs.onedatafs/$(PKG_VERSION)/download/linux-64/fs.onedatafs-$(PKG_VERSION)-py36_0.tar.bz2" >> conda-pkg-list.txt
	echo "onedata-devel/fs.onedatafs/$(PKG_VERSION)/download/linux-64/fs.onedatafs-$(PKG_VERSION)-py37_0.tar.bz2" >> conda-pkg-list.txt
